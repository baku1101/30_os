...
/* mtask.c */
#define MAX_TASKS		1000	/* 最大タスク数 = MAX_TASKS_LV * MAX_TASKLEVELS */
#define TASK_GDT0		3		/* TSSをGDTの何番から割り当てるのか */
#define MAX_TASKS_LV	100     /* 一つのレベルごとの最大タスク数 */
#define MAX_TASKLEVELS	10		/* タスクレベルの数(レベル9 - 0) */
struct TSS32 {
